...
var angular = require('camunda-bpm-sdk-js/vendor/angular'),
    graph-lineDefinition = require('../cam-widget-graph-line');

require('../../../../vendor/ui-bootstrap-tpls-0.11.2-camunda');

var graph-lineModule = angular.module('graph-lineModule', ['ui.bootstrap']);
graph-lineModule.directive('camWidgetLoader', graph-lineDefinition);

var testModule = angular.module('testModule', [graph-lineModule.name]);
...
},{"../../../../vendor/ui-bootstrap-tpls-0.11.2-camunda":6,"../cam-widget-graph-line":1,"camunda-bpm-sdk-js/vendor/angular":5}],3:[function(require,module,exports){
/**
