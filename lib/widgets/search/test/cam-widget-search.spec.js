...
describe('Search Widget', function() {
  ...
  describe('local persitence', function() {
    ...
    it('can restore a set of saved criteria', function() {
      var example = page.example(1);
      example.searchPills().then(function(pills) {
        pills.forEach(function(pill) {
          pill.removeButton().click();
        });
      });
    ...
    describe.only('with groups', function() {
      var example;
      ...
      beforeEach(function() {
        ...
        browser.executeScript('localStorage.setItem(\'camunda\', \' ' + json + ' \')')
          // .then(function() {
          //   //
          // })
        ;
      ...
      it('shows all the saved sets if the group is not defined', function() {
        example.searchInput().click();
        browser.sleep(3000);
        example.inputDropdownOption(0).click();
      });
