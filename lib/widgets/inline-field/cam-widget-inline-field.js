  ...
  function(
    ...
    return {
      ...
      link: function(scope, element) {
        ...
        function isMonthHeaderButton(evt) {
          console.info($ctrlsEl, evt.target.matches('[ng-switch-when] tbody *'), $ctrlsEl[0].contains(evt.target));
          var id = evt.target.id || evt.target.parentNode.id;
          return id.indexOf('datepicker-') === 0 && id.indexOf('-title') > 0;
        }
